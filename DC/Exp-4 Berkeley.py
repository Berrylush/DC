...
# Enter no. of clients 2
# Enter time of clients in HH:MM : 5:04 5:07
# Enter the time of server 4:14
# Server is behind ,increase its clock by 0:34:20,so now its time is 4:48:20
#
# Client 0 is ahead by 0:15:40.
# Therefore decrease its clock to get 4:48:20
#
# Client 1 is ahead by 0:18:40.
# Therefore decrease its clock to get 4:48:20
