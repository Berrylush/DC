...
# Enter total number of available instances of resource 1 : 2
# Enter total number of available instances of resource 2 : 2
# Enter total number of available instances of resource 3 : 2
#
# Enter information for Process 1 :
# Enter max demand of instances of resource 1 for Process 1 : 3
# Enter number of instances of resource 1 allocated to Process 1 : 2
# Enter max demand of instances of resource 2 for Process 1 : 1
# Enter number of instances of resource 2 allocated to Process 1 : 1
# Enter max demand of instances of resource 3 for Process 1 : 0
# Enter number of instances of resource 3 allocated to Process 1 : 0
#
# Enter information for Process 2 :
# Enter max demand of instances of resource 1 for Process 2 : 3
...
# Enter number of instances of resource 2 allocated to Process 2 : 1
# Enter max demand of instances of resource 3 for Process 2 : 2
# Enter number of instances of resource 3 allocated to Process 2 : 3
#
# Enter information for Process 3 :
# Enter max demand of instances of resource 1 for Process 3 : 3
# Enter number of instances of resource 1 allocated to Process 3 : 2
# Enter max demand of instances of resource 2 for Process 3 : 2
# Enter number of instances of resource 2 allocated to Process 3 : 1
# Enter max demand of instances of resource 3 for Process 3 : 3
# Enter number of instances of resource 3 allocated to Process 3 : 0
#
# ***** Initially *****
# Available Resources :  [-4, -1, -1]
# Allocated Matrix :-
# [[2, 1, 0], [2, 1, 3], [2, 1, 0]]
#
# Max Matrix :-
